...
public class LabTestsResponse {
    ...
    public LabTestsResponse(int patientID, String testName, String record, int inputter, String status,
            Date dateRecommended, int recommender, Date dateFilled) {
    ...
    public LabTestsResponse(String testName, String record, int inputter, String status, Date dateRecommended,
    ...
    public LabTestsResponse(String testName2, int inputter2, String status2, Date dateRecommended2,
